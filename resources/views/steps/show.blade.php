    ...
    <div class="u-display-flex-center js-height-hold">
        <div class="p-card u-bg-white u-border-default">
            ...
            <div class="p-card__body">
                ...
                <a href="https://twitter.com/share?url=https://webukatustep.herokuapp.com/steps/{{ $parent_step->id }}&text=@php echo urlencode('注目のSTEP')@endphp&hashtags=@php echo urlencode('あなたの人生のSTEPを共有しよう')@endphp" data-show-count="false" target="_blank">
